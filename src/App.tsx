...
import { Heart, Sparkles, Camera, Gift, Star, MailOpen, Lock, Unlock, Key } from 'lucide-react';
    ...
    return (
        ...
        >
            <motion.div whileHover={{ y: -10 }} className="glass p-8 rounded-[32px] text-center space-y-4 shadow-lg border border-white/50 cursor-default">
                <div className="mx-auto w-14 h-14 bg-pink-100 flex items-center justify-center rounded-full text-pink-500 mb-6 shadow-inner">
                    <Star size={28} fill="currentColor" />
                </div>
                <h3 className="font-serif italic text-3xl text-pink-800">Your Smile</h3>
                <p className="text-gray-600 font-sans text-lg">It literally has the power to turn my worst days into my absolute best.</p>
            </motion.div>
            <motion.div whileHover={{ y: -10 }} className="glass p-8 rounded-[32px] text-center space-y-4 shadow-lg border border-white/50 cursor-default">
                <div className="mx-auto w-14 h-14 bg-purple-100 flex items-center justify-center rounded-full text-purple-500 mb-6 shadow-inner">
                    <Heart size={28} fill="currentColor" />
                </div>
                <h3 className="font-serif italic text-3xl text-purple-800">Your Eyes</h3>
                <p className="text-gray-600 font-sans text-lg">I could get lost in them forever; they hold a whole universe of love.</p>
            </motion.div>
            <motion.div whileHover={{ y: -10 }} className="glass p-8 rounded-[32px] text-center space-y-4 shadow-lg border border-white/50 cursor-default">
                <div className="mx-auto w-14 h-14 bg-rose-100 flex items-center justify-center rounded-full text-rose-500 mb-6 shadow-inner">
                    <Sparkles size={28} />
                </div>
                <h3 className="font-serif italic text-3xl text-rose-800">Your Vibe</h3>
...
const BaniyaVault = () => {
    ...
    return (
        ...
        >
            <h3 className="font-serif italic text-4xl text-rose-800">The Secret Vault</h3>
            
            {unlocked ? (
                 <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="space-y-6 py-4">
                     <Unlock className="mx-auto text-rose-500" size={56} />
                     <p className="font-hand text-5xl text-pink-600 font-bold -rotate-2">Access Granted!</p>
                     <p className="text-xl sm:text-2xl font-sans text-gray-700 p-6 bg-white/50 rounded-3xl leading-relaxed border border-rose-100 shadow-sm">
                 ...
                 <div className="space-y-6 py-4">
                      <motion.div animate={shake ? { x: [-10, 10, -10, 10, 0] } : {}} transition={{ duration: 0.4 }}>
                         <Lock className={`mx-auto ${shake ? 'text-red-400' : 'text-rose-300'}`} size={64} />
                      </motion.div>
                      ...
                      <div className="flex gap-3 justify-center items-center">
                          <input 
                              type="text" 
                              maxLength={11}
                              className={`w-40 sm:w-48 text-center text-3xl font-bold bg-white/70 border-2 ${shake ? 'border-red-400 outline-red-400' : 'border-rose-200 outline-rose-400'} rounded-2xl p-4 transition-colors`}
                              value={code}
                              onChange={e => setCode(e.target.value)}
                              placeholder="***"
                              onKeyDown={(e) => e.key === 'Enter' && handleUnlock()}
                          />
                          <button onClick={handleUnlock} className="bg-rose-400 text-white p-4 rounded-2xl shadow-lg hover:bg-rose-500 hover:shadow-xl transition-all transform hover:-translate-y-1">
                              <Key size={32} />
                          </button>
                      </div>
                      <div className="h-4">
...
const NeedsChart = () => {
    return (
        ...
        >
            <h3 className="font-serif italic text-4xl text-rose-800 text-center">A Scientific Breakdown of Me</h3>
            <div className="h-72 sm:h-80 w-full relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <Heart className="text-pink-400 animate-pulse w-12 h-12 sm:w-16 sm:h-16" fill="currentColor" />
                </div>
            </div>
    ...
    return (
        ...
        >
             <div className="space-y-6">
                 <h2 className="font-serif italic text-4xl sm:text-5xl text-rose-800">For the Girl Who Owns My Future</h2>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left mt-8">
                 <div className="bg-white/60 p-8 rounded-3xl space-y-4 border border-pink-100 shadow-sm relative hover:shadow-md transition-shadow">
                     <span className="absolute -top-6 -left-2 text-5xl opacity-80">✨</span>
                     <p className="font-hand text-3xl md:text-4xl text-pink-700 leading-relaxed font-bold">
                 ...
                 <div className="bg-white/60 p-8 sm:p-10 rounded-3xl space-y-6 border border-purple-100 shadow-sm relative flex flex-col justify-center text-center sm:text-left hover:shadow-md transition-shadow">
                     <Heart className="absolute -top-4 -right-2 text-pink-400 rotate-12 opacity-70" size={48} fill="#fbc2eb" />
                     <h3 className="font-serif italic text-2xl text-purple-800">My Only Muse</h3>
    ...
    return (
      <>
        ...
        <div className="min-h-screen flex items-center justify-center p-4 relative z-10 overflow-hidden">
          ...
          >
            <div className="absolute -top-12 -right-12 w-40 h-40 bg-pink-300/40 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-12 -left-12 w-40 h-40 bg-purple-300/40 rounded-full blur-3xl"></div>
            ...
            <div className="flex-1 text-center md:text-left space-y-6 relative z-10">
              <motion.h1 
                ...
                className="text-6xl md:text-8xl font-hand text-pink-600 mb-4 -rotate-2 transform font-bold drop-shadow-sm leading-tight"
              >
              ...
              >
                Thank you, my gorgeous <span className="font-serif italic text-pink-500 font-bold">Apoorva</span>. <br /><br />
      ...
      <div className="min-h-screen flex flex-col items-center justify-between p-4 sm:p-8 relative z-10 overflow-x-hidden">
        ...
        <header className="w-full max-w-6xl flex justify-between items-center mb-8 relative z-10">
          ...
          >
            ...
            <span className="text-pink-600 font-semibold tracking-wide uppercase text-sm">Live Admiration Feed</span>
          </motion.div>
          <motion.div 
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            <h2 className="font-hand text-4xl sm:text-5xl text-pink-600 font-bold -rotate-2 transform inline-block drop-shadow-sm">For Apoorva</h2>
            <p className="text-pink-400 text-xs sm:text-sm font-semibold uppercase tracking-widest mt-1">My Universe, My Heart ✨</p>
          </motion.div>
        </header>
        ...
        >
          ...
          <div className="space-y-8 relative z-10 pt-4 px-2">
            <h1 className="text-4xl md:text-6xl font-serif text-gray-800 tracking-tight leading-loose">
              To my dearest <br/> 
              <span className="font-hand text-6xl md:text-[7rem] text-pink-500 transform inline-block -rotate-3 mt-6 drop-shadow-sm font-bold">Apoorva,</span>
            </h1>
          </div>
            ...
            <div className="flex flex-col-reverse md:flex-row items-center gap-12 justify-center mt-12 pt-8 border-t border-white/40">
              <div className="flex-1 text-center md:text-left space-y-6">
                <p>
                  ...
                  <span className="font-hand text-5xl sm:text-[4rem] text-pink-500 mx-2 font-bold align-middle inline-block transform -rotate-2">beauty,</span>
                  your irresistible 
                  <span className="font-hand text-5xl sm:text-[4rem] text-purple-500 mx-2 font-bold align-middle inline-block transform rotate-2">cuteness,</span>
                  and that boundless 
                  <span className="font-hand text-5xl sm:text-[4rem] text-rose-500 mx-2 font-bold align-middle inline-block transform -rotate-1">charm</span> 
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pb-2 min-h-[80px]">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={handleAgree}
                className="px-10 py-5 bg-gradient-to-r from-pink-500 to-rose-400 text-white font-bold rounded-[30px] shadow-xl shadow-pink-300 hover:shadow-2xl transition-all flex items-center justify-center gap-3 text-2xl z-20 w-full sm:w-auto overflow-hidden relative group"
              >
              ...
              <motion.button
                ...
                className="px-10 py-5 glass text-gray-600 hover:text-pink-600 font-bold rounded-[30px] hover:bg-white/80 transition-colors flex items-center justify-center text-xl z-10 w-full sm:w-auto border-2 border-transparent hover:border-pink-200 min-w-[220px]"
              >
        ...
        <footer className="w-full max-w-6xl glass py-6 px-8 md:px-12 rounded-[32px] flex flex-col sm:flex-row justify-between items-center mt-16 relative z-10 gap-6 sm:gap-0 shadow-lg mb-4">
          <div className="flex gap-8 sm:gap-16 text-center sm:text-left">
            <div className="flex flex-col gap-2">
              <span className="text-[10px] sm:text-xs text-pink-500 font-bold uppercase tracking-widest">Adoration Streak</span>
              <span className="font-hand text-2xl sm:text-3xl text-gray-800 font-bold">Infinity & Counting</span>
            </div>
            <div className="flex flex-col gap-2">
              <span className="text-[10px] sm:text-xs text-purple-500 font-bold uppercase tracking-widest">Favorite Feature</span>
